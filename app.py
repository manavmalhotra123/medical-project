...
def predictDisease(symptoms):
    ...
    # basically doing the ensembling which is done by taking mode in case of classification and taking weighted average in case of regression
...
selected = st.title('Medicine Advisor')

# getting the input data from the user
col1, col2, col3 = st.columns(3)
with col1:
    symptoms = st.text_input("Enter your symptoms here:")
